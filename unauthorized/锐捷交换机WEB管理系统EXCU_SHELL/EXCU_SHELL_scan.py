...
if __name__ == '__main__':
	...
	arg.add_argument("-u",
						"--url",
						help="Target URL; Example:python3 Ruijie_EXCU_SHELL_scan.py -u http://ip:port")
	arg.add_argument("-f",
						"--file",
						help="url_list; Example:python3 Ruijie_EXCU_SHELL_scan.py -f url.txt")
