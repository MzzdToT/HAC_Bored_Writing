...
def check_vuln(url):
	...
	url2 = url.scheme + '://' + url.netloc + '/defaultroot/evoInterfaceServlet?paramType=user'
	try:
...
if __name__ == '__main__':
	...
	'''
	print(show + '\n')
	arg=ArgumentParser(description='check vuln By when')
	arg.add_argument("-u",
						"--url",
						help="Target URL; Example:python3 Wanhu_userlist_scan.py -u http://ip:port")
	arg.add_argument("-f",
						"--file",
						help="url_list; Example:python3 Wanhu_userlist_scan.py -f url.txt")
